...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _NULLABLESTRING._serialized_start=79
  _NULLABLESTRING._serialized_end=162
  _ERRORREPORTPROTO._serialized_start=164
  _ERRORREPORTPROTO._serialized_end=223
