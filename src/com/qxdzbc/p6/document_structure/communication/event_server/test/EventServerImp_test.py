...
from com.qxdzbc.p6.document_structure.communication.event_server.EventServerErrors import EventServerErrors
...
from com.qxdzbc.p6.document_structure.util.for_test.MockProto import MockToProto
...
class EventServerImp_test(unittest.TestCase):
    ...
    def test_handle_noHandler(self):
        ...
        self.assertEqual(EventServerErrors.NoReactorError.header.errorCode, errReportProto.errorCode)
