...
from com.qxdzbc.p6.document_structure.worksheet.WorksheetErrors import WorksheetErrors
from com.qxdzbc.p6.proto.WorksheetProtos_pb2 import RenameWorksheetRequestProto
...
class RenameWorksheetReactor_test(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.er = EventServerReactors(wbGetter,appGetter = appGetter, rangeGetter = MagicMock(), wsGetter = MagicMock())
