...
from com.qxdzbc.p6.document_structure.communication.event.data_structure.cell_event.CellUpdateContent import \
    CellUpdateContent
from com.qxdzbc.p6.document_structure.communication.event.data_structure.cell_event.CellUpdateEntry import \
    CellUpdateEntry
