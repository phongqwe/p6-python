...
from com.qxdzbc.p6.document_structure.range.Ranges import Ranges
...
from com.qxdzbc.p6.document_structure.util.Util import typeCheck
...
class WorksheetImp(BaseWorksheet):
    ...
    def renameRs(self, newSheetName: str) -> Result[None, ErrorReport]:
        ...
        if newNameOk:
            ...
            wb = self.workbook
            wb.renameWorksheetName(oldName, self)
            return Ok(None)
        else:
